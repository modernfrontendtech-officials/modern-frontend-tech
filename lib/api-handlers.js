require("./load-env");
const { getHealth, getProfile, isAllowedOrigin, recordProfileActivity, signin, signup } = require("./auth-service");
...
const handleProfileRequest = createHandler("GET", (_, req) => getProfile(req));
const handleProfileActivityRequest = createHandler("POST", (payload, req) => recordProfileActivity(payload, req), true);
